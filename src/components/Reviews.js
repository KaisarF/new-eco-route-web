        ...
        <div className="reviewCont">
          ...
          <Carousel className="rightRevCont">
            ...
            <CarouselItem className="revCarouselItem">
              ...
              <p>
                Maecenas vel mi pulvinar, vehicula nunc ut, bibendum libero.
                Integer at sodales quam. Donec nec est justo. Phasellus
                elementum molestie elit, in cursus odio dictum vel.
              </p>
              <div className="reviewProfile">
                <img
                  src={require("../assets/placeholder.jpg")}
            ...
            <CarouselItem className="revCarouselItem">
              ...
              <p>
                Phasellus ut vestibulum tellus. Nullam erat ante, pulvinar quis
                pharetra quis, commodo vel risus. Aenean tellus tellus, suscipit
                facilisis orci non, mollis accumsan leo. Nunc maximus et turpis
                at tempor. In eget efficitur lacus, et rutrum nulla.
              </p>
              <div className="reviewProfile">
                <img
                  src={require("../assets/placeholder.jpg")}
